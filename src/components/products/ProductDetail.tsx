                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <button
                      ...
                      className="text-obsidian underline underline-offset-4 hover:text-copper transition-colors"
                    >
                      Size Guide
                    </button>
                  </div>
        ...
        {showSizeGuide && (
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className="relative max-w-2xl w-full max-h-[90vh] bg-ivory rounded-lg shadow-2xl overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              <button
                onClick={() => setShowSizeGuide(false)}
                className="absolute top-3 right-3 z-10 bg-ivory/80 backdrop-blur-sm p-1.5 rounded-full shadow-md text-obsidian hover:bg-ivory transition-colors"
